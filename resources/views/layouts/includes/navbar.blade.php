        ...
        <div class="flex items-center justify-between h-16 md:justify-start py-3 md:space-x-2">
            ...
            <img class="h-8 w-auto sm:h-10" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg" alt="">
                    ...
                    <a href="{{ route('dashboard') }}"
                        class="inline-flex m-auto p-2 mx-2 hover:text-white font-bold rounded-lg shadow-lg my-auto">Dashboard</a>
                </div>
                ...
                <div class="relative inline-flex items-center hover:text-white py-2 px-2 cursor-pointer group">
                    ...
                    <div
                        class="absolute w-44 left-0 top-full bg-white shadow-md invisible opacity-0 group-hover:opacity-100 group-hover:visible transition duration-300 z-50 divide-y divide-gray-300 divide-dashed overflow-hidden">
                        <a href="#"
            ...
            <div class="flex flex-grow items-center justify-end">
                <nav :class="openNavbar ? 'show' : 'hidden'"
                    class="absolute sm:relative sm:flex flex-grow items-center justify-end sm:flex-1 lg:w-0 sm:top-0 top-16 left-0 bg-gray-800 w-full py-2 px-2">
                ...
                <div class="inline-flex relative float-right">
                    ...
                    <div x-data="{ openDropdown: false }" class="relative">
                        ...
                        <div x-show="openDropdown" x-on:click.away="openDropdown = false"
                            ...
                            <a href="#"
                                class="block px-4 py-2 text-gray-700 hover:bg-gray-600 hover:text-white">
